...
use App\Http\Controllers\API\Device\AbuseReportsController;
use App\Http\Controllers\API\Device\AdSpacesController;
use App\Http\Controllers\API\Device\AuthController;
use App\Http\Controllers\API\Device\BankTransfersController;
use App\Http\Controllers\API\Device\BlogCategoriesController;
use App\Http\Controllers\API\Device\BlogCommentsController;
use App\Http\Controllers\API\Device\BlogImagesController;
use App\Http\Controllers\API\Device\BlogPostsController;
use App\Http\Controllers\API\Device\BlogTagsController;
use App\Http\Controllers\API\Device\CategoriesController;
use App\Http\Controllers\API\Device\CategoriesLangController;
use App\Http\Controllers\API\Device\CiSessionsController;
use App\Http\Controllers\API\Device\CommentsController;
use App\Http\Controllers\API\Device\ContactsController;
use App\Http\Controllers\API\Device\ConversationMessagesController;
use App\Http\Controllers\API\Device\ConversationsController;
use App\Http\Controllers\API\Device\CouponProductsController;
use App\Http\Controllers\API\Device\CouponsController;
use App\Http\Controllers\API\Device\CouponsUsedController;
use App\Http\Controllers\API\Device\CurrenciesController;
use App\Http\Controllers\API\Device\CustomFieldsCategoryController;
use App\Http\Controllers\API\Device\CustomFieldsController;
use App\Http\Controllers\API\Device\CustomFieldsOptionsController;
use App\Http\Controllers\API\Device\CustomFieldsOptionsLangController;
use App\Http\Controllers\API\Device\CustomFieldsProductController;
use App\Http\Controllers\API\Device\DigitalFilesController;
use App\Http\Controllers\API\Device\DigitalSalesController;
use App\Http\Controllers\API\Device\EarningsController;
use App\Http\Controllers\API\Device\FollowersController;
use App\Http\Controllers\API\Device\FontsController;
use App\Http\Controllers\API\Device\GeneralSettingsController;
use App\Http\Controllers\API\Device\HomepageBannersController;
use App\Http\Controllers\API\Device\ImagesController;
use App\Http\Controllers\API\Device\ImagesFileManagerController;
use App\Http\Controllers\API\Device\ImagesVariationController;
use App\Http\Controllers\API\Device\InvoicesController;
use App\Http\Controllers\API\Device\KnowledgeBaseCategoriesController;
use App\Http\Controllers\API\Device\KnowledgeBaseController;
use App\Http\Controllers\API\Device\LanguagesController;
use App\Http\Controllers\API\Device\LanguageTranslationsController;
use App\Http\Controllers\API\Device\LocationCountriesController;
use App\Http\Controllers\API\Device\LocationStatesController;
use App\Http\Controllers\API\Device\MediaController;
use App\Http\Controllers\API\Device\MembershipPlansController;
use App\Http\Controllers\API\Device\MembershipTransactionsController;
use App\Http\Controllers\API\Device\OrderProductsController;
use App\Http\Controllers\API\Device\OrdersController;
use App\Http\Controllers\API\Device\OrderShippingController;
use App\Http\Controllers\API\Device\PagesController;
use App\Http\Controllers\API\Device\PaymentGatewaysController;
use App\Http\Controllers\API\Device\PaymentsController;
use App\Http\Controllers\API\Device\PaymentSettingsController;
use App\Http\Controllers\API\Device\PayoutsController;
use App\Http\Controllers\API\Device\ProductDetailsController;
use App\Http\Controllers\API\Device\ProductLicenseKeysController;
use App\Http\Controllers\API\Device\ProductsController;
use App\Http\Controllers\API\Device\ProductSettingsController;
use App\Http\Controllers\API\Device\PromotedTransactionsController;
use App\Http\Controllers\API\Device\QuoteRequestsController;
use App\Http\Controllers\API\Device\RefundRequestsController;
use App\Http\Controllers\API\Device\RefundRequestsMessagesController;
use App\Http\Controllers\API\Device\ReviewsController;
use App\Http\Controllers\API\Device\RolesPermissionsController;
use App\Http\Controllers\API\Device\RoutesController;
use App\Http\Controllers\API\Device\SettingsController;
use App\Http\Controllers\API\Device\ShippingAddressesController;
use App\Http\Controllers\API\Device\ShippingClassesController;
use App\Http\Controllers\API\Device\ShippingDeliveryTimesController;
use App\Http\Controllers\API\Device\ShippingZoneLocationsController;
use App\Http\Controllers\API\Device\ShippingZoneMethodsController;
use App\Http\Controllers\API\Device\ShippingZonesController;
use App\Http\Controllers\API\Device\SliderController;
use App\Http\Controllers\API\Device\StorageSettingsController;
use App\Http\Controllers\API\Device\SubscribersController;
use App\Http\Controllers\API\Device\SupportSubticketsController;
use App\Http\Controllers\API\Device\SupportTicketsController;
use App\Http\Controllers\API\Device\TransactionsController;
use App\Http\Controllers\API\Device\UserController;
use App\Http\Controllers\API\Device\UsersController;
use App\Http\Controllers\API\Device\UsersMembershipPlansController;
use App\Http\Controllers\API\Device\UsersPayoutAccountsController;
use App\Http\Controllers\API\Device\VariationOptionsController;
use App\Http\Controllers\API\Device\VariationsController;
use App\Http\Controllers\API\Device\WishlistController;
